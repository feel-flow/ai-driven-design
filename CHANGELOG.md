...
- **Obsidian 統合の完全排除**（2026-05-07、Issue #402）
  - 削除: `docs-template/.obsidian/`（4 設定ファイル）、`docs-template/08-knowledge/OBSIDIAN_GUIDE.md`、`OBSIDIAN_EVALUATION.md`、`mcp/src/obsidian/`（5 ソース）、`scripts/obsidian-sync.mjs`、`scripts/setup-obsidian-hook.sh`
